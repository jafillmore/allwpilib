...
static LimitedHandleResource<HAL_InterruptHandle, HAL_Interrupt, kNumInterrupts,
...
static int64_t WaitForInterruptDigital(HAL_InterruptHandle handle,
                                       HAL_Interrupt* interrupt, double timeout,
                                       bool ignorePrevious) {
